...
\begin{itemize}
    ...
    Gambar yang terlihat pada viewport diproses teksnya menggunakan
    Tesseract.js apabila analisis konteks (nama file, \texttt{alt},
    \texttt{aria-label}, teks container terdekat) tidak menemukan kecocokan.
