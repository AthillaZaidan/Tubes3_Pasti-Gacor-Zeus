...
\begin{enumerate}
    ...
    \item Jika OCR diaktifkan, program juga memindai gambar yang terlihat dan
    menjalankan pipeline deteksi terhadap teks hasil OCR maupun konteks gambar.
...
\begin{enumerate}
    ...
    \item \textbf{Gambar halaman}, yaitu elemen gambar atau elemen visual yang
    terlihat pada viewport dan dapat diproses melalui OCR atau teks konteks
    di sekitar gambar.
